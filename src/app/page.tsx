...
export default function LandingPage() {
      ...
      features={[
        {
          ...
          description: "Restoring function and aesthetic appearance with precision.",
      ...
      testimonials={[
        {
          ...
          company: "Chennai",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/cheerful-woman-entertaining-herself-by-dancing_482257-110602.jpg",
        },
        {
          id: "t2",
          name: "Rajesh Kumar",
  ...
  <div id="socialProof" data-section="socialProof">
      ...
      names={[
        "Chennai Medical Association",
        "Plastic Surgery Council",
        "National Accreditation Board",
        "International Aesthetic Society",
        "Advanced Surgical Forum",
      ]}
    />
  </div>
